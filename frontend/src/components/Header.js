              ...
              <nav className="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div className="iq-search-bar device-search">
                      <form action="#" className="searchbox">
                          ...
                          <input type="text" className="text search-input" placeholder="Search here..."></input>
                      </form>
                  </div>
                                        ...
                                        <div className="card shadow-none m-0">
                                            ...
                                            <div className="card-body p-0">
                                                <a href="#" className="iq-sub-card">
                                                    <div className="d-flex align-items-center">
                                                         <div className="">
                                                        <img className="avatar-40 rounded" src="../assets/images/user/01.jpg" alt=""></img>
                                                            </div>
                                                ...
                                                <a href="#" className="iq-sub-card">
                                                    <div className="d-flex align-items-center">
                                                        <div className="">
                                                            <img className="avatar-40 rounded" src="../assets/images/user/02.jpg" alt=""></img>
                                                        </div>
                                                        <div className="ms-3 w-100">
                                                ...
                                                <a href="#" className="iq-sub-card">
                                                    <div className="d-flex align-items-center">
                                                         <div className="">
                                                            <img className="avatar-40 rounded" src="../assets/images/user/03.jpg" alt=""></img>
                                                                </div>
                                                        <div className="ms-3 w-100">
                                                ...
                                                <a href="#" className="iq-sub-card">
                                                    <div className="d-flex align-items-center">
                                                         <div className="">
                                                            <img className="avatar-40 rounded" src="../assets/images/user/04.jpg" alt=""></img>
                                                        </div>
                                        ...
                                        <div className="card shadow-none m-0">
                                            ...
                                            <div className="card-body p-0 ">
                                                ...
                                                <a href="#" className="iq-sub-card">
                                                    <div className="d-flex align-items-center">
                                                        <div className="">
                                                            <img className="avatar-40 rounded" src="../assets/images/user/05.jpg" alt=""></img>
                                                        </div>
                                                        <div className="ms-3">
                                  ...
                                  <div className="card shadow-none m-0">
                                      ...
                                      <div className="card-body p-0 ">
                                          ...
                                          <div className="d-inline-block w-100 text-center p-3">
                                              <a className="btn btn-primary iq-sign-btn" href="sign-in.html" role="button">Sign
